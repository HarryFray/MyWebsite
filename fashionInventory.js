...
listDesignerShoePrice(currentInventory)

function listDesignerShoePrice(currentInventory){
  currentInventory.forEach(function(element){
    element.shoes.forEach(function(shoes){
      console.log (element.name + ', ' + shoes.name + ', ' + shoes.price)
    })
  })
}
